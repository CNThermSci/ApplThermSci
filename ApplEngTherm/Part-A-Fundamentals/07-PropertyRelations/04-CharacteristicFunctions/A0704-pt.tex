...
%-----------------------------------------------------------------------------------------------
    ...
    \begin{frame}[allowframebreaks]{Variáveis Reduzidas}
        ...
        %
        \begin{alignat*}{5}
            \alert{P^\star &\equiv P_{cr}},  & \qquad & \qquad & T^\star &\equiv T_{cr},          & \qquad & \qquad & v^\star &\equiv v_{cr}, \\
            \alert{s^\star &\equiv RZ_{cr}}, & \qquad & \qquad & u^\star &\equiv T^\star s^\star, & \qquad & \qquad & a^\star &\equiv u^\star.
        \end{alignat*}
