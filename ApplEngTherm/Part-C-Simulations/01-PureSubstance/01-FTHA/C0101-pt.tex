...
%-----------------------------------------------------------------------------------------------
    ...
    \begin{frame}{Abordagem de Solução}\vspace*{-2em}
        ...
        \end{itemize}
        \uncover<6->{Divisão em subprocessos $i$, com $i \in \mathbb{Z}$, durante o qual:}
        \begin{itemize}
            \item<7-> O sistema evolve do estado-$i$ para o estado-$(i+1)$; e
            \item<8-> As interações de calor e de trabalho são $q_i$ e $w_i$, respectivamente.
        \end{itemize}
    \end{frame}
    %-------------------------------------------------------------------------------------------
