...
%-----------------------------------------------------------------------------------------------
    ...
    \begin{frame}{Modelo de $\bar{c}_p(T)$ Polinomial: $\bar{u}(T)$}\vspace*{-2em}
        \begin{align*}
            \uncover<1->{
                \bar{u}(T)      &= \int_{T_{ref}}^T \bar{c}_v(T)
                                =  \int_{T_{ref}}^T \sum_{i=1}^4 b_iT^{i-1},
                                & T_{min} \leqslant T \leqslant T_{max}
                                & \qquad\rightharpoondown
            }
            \uncover<2->{
    ...
    \begin{frame}{Modelo de $\bar{c}_p(T)$ Polinomial: $\bar{h}(T) = \bar{u}(T) + \bar{R}T$}%
        ...
        \begin{align*}
            \uncover<1->{
                \bar{h}(T)      &= \int_{T_{ref}}^T \bar{c}_p(T) + \bar{R}T
                                =  \int_{T_{ref}}^T \sum_{i=1}^4 a_iT^{i-1} + \bar{R}T,
                                & T_{min} \leqslant T \leqslant T_{max}
                                & \qquad\rightharpoondown
            }
            \uncover<2->{
