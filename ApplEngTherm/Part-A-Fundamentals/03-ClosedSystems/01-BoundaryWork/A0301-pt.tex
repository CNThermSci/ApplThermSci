...
\subsection{Quantitativo}
    ...
    \begin{frame}{Trabalho de Fronteira -- Ciclo}\vspace*{-2em}
        ...
        \column{0.55\textwidth}
        \begin{itemize}
            \item<1-> Expansão $1$--$2$ via `C'
            \item<1-> Assumindo expansão-compressão pelos caminhos `C' e `A' \\[\medskipamount]
        ...
        \column{0.45\textwidth}
            \begin{figure}
                ...
                \only<7>{\includegraphics[width=5.0cm]{fig/A0301-pt-HPistCylPlotCycle-05.pdf}}
                \only<8>{\includegraphics[width=5.0cm]{fig/A0301-pt-HPistCylPlotCycle.pdf}}
            \end{figure}
        \end{columns}
    \end{frame}
    %-------------------------------------------------------------------------------------------
