...
%    %-------------------------------------------------------------------------------------------
    ...
    \begin{frame}{Balanço de Energia -- $E_{sist}$}\vspace*{-2em}
        ...
        \begin{enumerate}
            \item<2-> $E_{micro} \equiv U_{sist}$, a \alert{energia interna}, em
                \kilo\joule\per\kilogram; \\[\medskipamount]
            \item<3-> $E_{macro} = E_c + E_p$, a soma das energias \alert{cinética}, e
                \alert{potencial}, em \kilo\joule\per\kilogram, onde: \\[\medskipamount]
            \item<4-> $E_c = m\mathbb{V}^2/2$, com $\llbracket\mathbb{V}\rrbracket =
                \sqrt{\kilo\joule\per\kilogram} = \unit{\sqrt{1000}}{\meter\per\second} \approx
                \unit{31.62}{\meter\per\second}$, ou \\[\medskipamount]
            \item<5-> $E_c = m{\scriptstyle\mathbb{V}}^2/2$, com
                $\llbracket{\scriptstyle\mathbb{V}}\rrbracket = \meter\per\second$;
                \\[\medskipamount]
            \item<6-> $E_p = g\mathbb{Z}$, com $\llbracket g\rrbracket =
                \meter\per\squaren\second$ e $\llbracket\mathbb{Z}\rrbracket = \kilo\meter$, ou
                \\[\medskipamount]
            \item<7-> $E_p = g{\scriptstyle\mathbb{Z}}/1000$, com $\llbracket g\rrbracket
                = \meter\per\squaren\second$ e
                $\llbracket{\scriptstyle\mathbb{Z}}\rrbracket = \meter$.
                %\\[\medskipamount]
        \end{enumerate}
    \end{frame}
    %-------------------------------------------------------------------------------------------
