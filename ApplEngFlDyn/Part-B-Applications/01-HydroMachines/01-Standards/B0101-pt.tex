...
%-----------------------------------------------------------------------------------------------
    ...
    \begin{frame}{Termos de Energia Específica}\vspace*{-1em}
        ...
        \noindent\begin{longtable}{cp{110mm}}
            ...
            Energia específica --- energia mecânica por unidade de massa da água \\
            $E$ ($\joule\per\kilogram$) &
    ...
    \begin{frame}{Termos de Energia Específica (Cont.)}\vspace*{-1em}
        ...
        \noindent\begin{longtable}{cp{110mm}}
            ...
            $\sigma_0$ (--) &
            Número de Thoma zero, incipiente da redução de um parâmetro de performance \\
            $\sigma_1$ (--) &
            Número de Thoma um, de $1\%$ de redução de um parâmetro de performance \\
            $\sigma_i$ (--) &
