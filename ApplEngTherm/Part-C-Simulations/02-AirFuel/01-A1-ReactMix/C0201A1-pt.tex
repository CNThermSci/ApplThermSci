...
%-----------------------------------------------------------------------------------------------
    ...
    % !j 96 -i8
    %-------------------------------------------------------------------------------------------
    \begin{frame}{Energia Interna de Componentes Reativos:}\vspace*{-2em}
        \vspace*{0.8em}\begin{align*}
            \uncover<1->{
                \alert{U_k(T)}
                            &= n_k\bar{u}_k(T)
        ...
        \end{align*}
        \begin{itemize}
            \item<5-> \alert{$\bar{u}^0_{f,k}$} é a energia interna específica molar
                \alert{de formação} do componente $k$...
            \item<6-> \alert{$\bar{u}^0_{f,k}$} é a energia interna específica molar
                \alert{de formação} do componente $k$...
            \item<7-> \alert{$\bar{u}^0_k$} é a energia interna específica molar do comp.~$k$,
                \alert{em relação ao estado de ref.~$(P_0, T_0)$}.
        \end{itemize}
    \end{frame}
    %-------------------------------------------------------------------------------------------
