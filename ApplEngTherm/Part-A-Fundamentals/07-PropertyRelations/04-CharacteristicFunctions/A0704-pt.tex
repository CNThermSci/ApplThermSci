...
%-----------------------------------------------------------------------------------------------
    ...
    Derivatives can also be non-dimensionalized by isolating the dimensional variable from one of \EQs{eq:reduced}, and differentiating. For instance, in order
    to evaluate $\lxyz PTv$ with non-dimensional variables:
    %
    \begin{align}
