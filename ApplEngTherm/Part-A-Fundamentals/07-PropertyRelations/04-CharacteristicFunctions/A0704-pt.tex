...
%-----------------------------------------------------------------------------------------------
    ...
    \begin{frame}{Funções Características vs. Equações de Estado (EoS)}
        \begin{itemize}
            ...
            \item<2-> $\therefore$ a \alert{função característica} contém \alert{mais
            ...
            \item<3-> A entropia, \alert{$s\!:\!s(T, v)$} está `imbutida' em \alert{$a\!:\!a(T,
                ...
                \vspace*\bigskipamount
            \item<4-> $\therefore$ a \alert{função característica} reune o \alert{comportamento
                $P-v-T$} e o \alert{entrópico/calórico}!
        \end{itemize}
    \end{frame}
    %-------------------------------------------------------------------------------------------
