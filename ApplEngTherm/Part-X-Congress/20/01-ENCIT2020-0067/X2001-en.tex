        ...
        \column{0.75\textwidth}
            \uncover<1->{
                \begin{align*}
                    ...
                    \\[\medskipamount]
                    \alert{q_i} &
                    \alert{= q_{ent}\Delta{y_i}},\qquad\mbox{with}\qquad
                    \alert{\Delta{y_i}=y(t^{\star}_{i+1})-y(t^{\star})},\qquad\mbox{with}
                    \\[\medskipamount]
                    \alert{\alpha(t^{\star}_{\theta})} &
                    \alert{= \theta},\qquad\mbox{and}\qquad
                    \alert{t^{\star} \leftarrow 0}\qquad\mbox{whenever}\qquad
