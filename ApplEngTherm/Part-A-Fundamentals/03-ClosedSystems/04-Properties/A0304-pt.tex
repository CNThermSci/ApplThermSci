...
%-----------------------------------------------------------------------------------------------
    ...
    % !j 96 -i8
    %-------------------------------------------------------------------------------------------
    \begin{frame}{Gás Ideal --- $Pv = RT$}\vspace*{-2em}
        \begin{columns}
        \column{0.50\textwidth}
            ...
            \end{align}
            \uncover<5->{\noindent em processos isotérmicos.}
            \vfill
        \column{0.50\textwidth}
            \uncover<6->{Ainda, pela definição de \alert{$h$},}
            \begin{align}
                \uncover<7->{h & \equiv du + Pv}
                \uncover<8->{\quad\rightharpoondown\nonumber\\}
                \uncover<8->{h & = u + RT,\nonumber}
            \end{align}
            \uncover<9->{\noindent fazendo com que \alert{$h\!:\!h(T)$} também.}
            \vfill
        \end{columns}
    \end{frame}
    %-------------------------------------------------------------------------------------------
