    ...
    \begin{frame}{Dynamic Modeling --- Kinetics}\vspace*{-2em}
        ...
        \column{0.75\textwidth}
            \uncover<1->{
                ...
                \begin{align*}
                    \ddot{\mathsf{y}}_p &= \bsans{y}_{p}\pmb{\Omega},\quad\mbox{with}\quad
                        \bsans{y}_{p}   \equiv-\begin{bmatrix}
                            r(1+\beta_y) + h\mathsf{a}_{\omega} &
                            h(1+\beta_y)
                        \end{bmatrix},
                    \\[\bigskipamount]
                    \ddot{\mathsf{x}}_r &= \bsans{x}_{r}\pmb{\Omega},\quad\mbox{with}\quad
                        \bsans{x}_{r}   \equiv+\begin{bmatrix}
                            -h(1-r_g) &
                            r(1-r_g)
                        \end{bmatrix},\quad\mbox{and}
                    \\[\bigskipamount]
                    \ddot{\mathsf{y}}_r &= \bsans{y}_{r}\pmb{\Omega},\quad\mbox{with}\quad
