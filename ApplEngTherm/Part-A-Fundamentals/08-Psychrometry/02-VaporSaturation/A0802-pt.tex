...
%-----------------------------------------------------------------------------------------------
    ...
    \begin{frame}\vspace*{-2em}
        \begin{columns}
            \column{0.50\textwidth}
            \wwwfigWID{03-LN2}{jpg}{short}{0.9\textwidth}
            \column{0.50\textwidth}
            \wwwfigWID{04-windshield-ice}{jpg}{short}{0.9\textwidth}
        \end{columns}
    \end{frame}
    %-------------------------------------------------------------------------------------------
    ...
    \begin{frame}\vspace*{-2em}
        \begin{columns}
            \column{0.50\textwidth}
            \wwwfigWID{05-clouds-rain}{jpg}{short}{0.9\textwidth}
            \column{0.50\textwidth}
            \wwwfigWID{06-snow-storm}{jpg}{short}{0.9\textwidth}
        \end{columns}
    \end{frame}
    %-------------------------------------------------------------------------------------------
