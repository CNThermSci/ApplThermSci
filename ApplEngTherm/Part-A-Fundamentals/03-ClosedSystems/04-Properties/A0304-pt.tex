...
%-----------------------------------------------------------------------------------------------
    ...
    \begin{frame}{Entalpia -- Relação com Temperatura (Cont.)}\vspace*{-2em}
        ...
        \column{0.45\textwidth}
            ...
            \uncover<6->{Assim,}
            \begin{align}
                \uncover<7->{H & \equiv U + PV & [\kilo\joule],\nonumber\\}
                \uncover<8->{h & \equiv u + Pv & [\kilo\joule\per\kilogram].\nonumber}
            \end{align}
            \uncover<9->{E o termo origina  do  verbo  grego  \alert{``\GRtxt{enqa'lpw}''},  que
                significa:  \alert{``(eu)  aqueço''},  conforme  a  ilustração.   Ou   seja:   a
                ``entalpia''  de  um  sistema  pode  ser  mnemonizada  como  o  seu  ``nível  de
                aquecimento.''}}
        \end{columns}
    \end{frame}
    %-------------------------------------------------------------------------------------------
