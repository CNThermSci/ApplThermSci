...
%-----------------------------------------------------------------------------------------------
    ...
    \begin{frame}[allowframebreaks]{Variáveis Reduzidas}
        ...
        %
        \begin{alignat}{5}
            P^\star &\equiv P_{cr},  & \qquad & \qquad & T^\star &\equiv T_{cr},          & \qquad & \qquad & v^\star &\equiv v_{cr}, \\
            s^\star &\equiv RZ_{cr}, & \qquad & \qquad & u^\star &\equiv T^\star s^\star, & \qquad & \qquad & a^\star &\equiv u^\star.
        \end{alignat}
