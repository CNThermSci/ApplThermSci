...
%    %-------------------------------------------------------------------------------------------
    ...
    % !j 96 -i8
    %-------------------------------------------------------------------------------------------
    \begin{frame}{Balanço de Energia -- Em Processo (cont.)}\vspace*{-2em}
        Negligenciando as variações das energias macroscópicas do sistema fechado:
        \begin{itemize}
        ...
        \end{itemize}
        \uncover<4->{Tais variações são específicas a certas aplicações. Assim:}
        \begin{align*}
            \uncover<5->{
                Q_{liq,ent} - W_{liq,sai} & = \Delta U_{sist}
                \rightharpoondown & \text{o}&\text{u} &
                Q - W & = \Delta U_{sist}
                \rightharpoondown
            } \\[\medskipamount]
            \uncover<6->{
                \alert{Q_{liq,ent} - W_{liq,sai}} & \alert{= m(u_2 - u_1)}
                \rightharpoondown & \text{o}&\text{u} &
                Q - W & = m(u_2 - u_1)
                \rightharpoondown
            } \\[\medskipamount]
