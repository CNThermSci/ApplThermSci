...
\subsection{Quantitativo}
    ...
    \begin{frame}{Trabalho de Fronteira -- Ciclo}\vspace*{-2em}
        ...
        \begin{itemize}
            ...
            \item<2-> Retorno ao estado $1$ requer \alert{consumo} de trabalho
        \end{itemize}
        \column{0.45\textwidth}
            \begin{figure}
                \only<1>{\includegraphics[width=5.0cm]{fig/A0301-pt-HPistCylPlotCycle-01.pdf}}
                \only<2>{\includegraphics[width=5.0cm]{fig/A0301-pt-HPistCylPlotCycle-02.pdf}}
            \end{figure}
        \end{columns}
    \end{frame}
    %-------------------------------------------------------------------------------------------
    ...
    \begin{frame}{Trabalho de Fronteira -- Ciclo}\vspace*{-2em}
        ...
        \begin{itemize}
            ...
            \item<2-> $W_{\mathrm{ciclo}} = (W_{12} + W_{21}) > 0$ é igual à \alert{área do
                ciclo} em \alert{coordenadas $P-V$}.
        \end{itemize}
        \column{0.45\textwidth}
            \begin{figure}
                \only<1>{\includegraphics[width=5.0cm]{fig/A0301-pt-HPistCylPlotCycle-03.pdf}}
                \only<2>{\includegraphics[width=5.0cm]{fig/A0301-pt-HPistCylPlotCycle-05.pdf}}
            \end{figure}
        \end{columns}
    \end{frame}
    %-------------------------------------------------------------------------------------------
