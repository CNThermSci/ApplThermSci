...
%-----------------------------------------------------------------------------------------------
    ...
    \begin{frame}[allowframebreaks]{Variáveis Reduzidas}
        ...
        Diferenciais e derivadas parciais também podem ser adimensionalizadas:
        %
        \begin{align*}
            \partial P &= P^\star\partial P_r,\qquad\mbox{e}\qquad \partial T = T^\star\partial T_r\qquad\rightharpoondown
            \\[\medskipamount]
            \alert{\dxyz PTv} &\alert{= \frac{P^\star}{T^\star}\dxyz{P_r}{T_r}{v_r} = \frac{P_{cr}}{T_{cr}}\dxyz{P_r}{T_r}{v_r}}.
        \end{align*}
    \end{frame}
    %------------------------------------------------------------------------------------------
