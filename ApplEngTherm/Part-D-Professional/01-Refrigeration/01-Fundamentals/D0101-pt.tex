...
%-----------------------------------------------------------------------------------------------
    ...
    %-------------------------------------------------------------------------------------------
    \begin{frame}\vspace*{-0em}
        \wwwfigH{vapor-01}{jpg}{url}
    \end{frame}
    %-------------------------------------------------------------------------------------------
    \begin{frame}\vspace*{-0em}
        \wwwfigH{vapor-02}{jpg}{url}
    \end{frame}
    %-------------------------------------------------------------------------------------------
    \begin{frame}\vspace*{-0em}
        \wwwfigH{vapor-03}{jpg}{url}
    \end{frame}
    %-------------------------------------------------------------------------------------------
    \begin{frame}\vspace*{-0em}
        \wwwfigH{vapor-04}{jpg}{url}
    \end{frame}
    %-------------------------------------------------------------------------------------------
    \begin{frame}\vspace*{-0em}
        \wwwfigH{vapor-05}{jpg}{url}
    \end{frame}
    %-------------------------------------------------------------------------------------------
    \begin{frame}\vspace*{-0em}
        \wwwfigH{vapor-06}{jpg}{url}
    \end{frame}
    %-------------------------------------------------------------------------------------------
    ...
    %-------------------------------------------------------------------------------------------
    \begin{frame}\vspace*{-0em}
        \wwwfigH{thermoelectric-01}{jpg}{url}
    \end{frame}
    %-------------------------------------------------------------------------------------------
    \begin{frame}\vspace*{-0em}
        \wwwfigH{thermoelectric-02}{jpg}{url}
    \end{frame}
    %-------------------------------------------------------------------------------------------
    \begin{frame}\vspace*{-0em}
        \begin{columns}
    ...
    \begin{frame}{Resfriadores Evaporativos}\vspace*{-0em}
        ...
        \column{0.45\textwidth}
            \begin{center}
                \begin{figure}
                    \includegraphics[width=0.9\textheight]{www/moringa-01.jpg}
                \end{figure}
            \end{center}
        \end{columns}
    \end{frame}
    %-------------------------------------------------------------------------------------------
    \begin{frame}\vspace*{-0em}
        \wwwfigH{evap-01}{jpg}{url}
    \end{frame}
    %-------------------------------------------------------------------------------------------
    \begin{frame}\vspace*{-0em}
        \wwwfigH{evap-02}{jpg}{url}
    \end{frame}
    %-------------------------------------------------------------------------------------------
    \begin{frame}\vspace*{-0em}
        \wwwfigH{evap-03}{jpg}{url}
    \end{frame}
    %-------------------------------------------------------------------------------------------
    \begin{frame}\vspace*{-0em}
        \wwwfigH{evap-04}{jpg}{url}
    \end{frame}
    %-------------------------------------------------------------------------------------------
    \begin{frame}\vspace*{-0em}
        \wwwfigH{evap-05}{jpg}{url}
    \end{frame}
    %-------------------------------------------------------------------------------------------
    \begin{frame}\vspace*{-0em}
        \wwwfigH{evap-06}{jpg}{url}
    \end{frame}
    %-------------------------------------------------------------------------------------------
    \begin{frame}\vspace*{-0em}
        \begin{columns}
            \column{0.5\textwidth}
            \wwwfigH{evap-07}{jpg}{short}
            \column{0.5\textwidth}
            \wwwfigH{evap-08}{jpg}{short}
        \end{columns}
    \end{frame}
    %-------------------------------------------------------------------------------------------
    \begin{frame}\vspace*{-0em}
        \begin{columns}
            \column{0.5\textwidth}
            \wwwfigH{evap-09}{jpg}{short}
            \column{0.5\textwidth}
            \wwwfigH{evap-10}{jpg}{short}
        \end{columns}
    \end{frame}
    %-------------------------------------------------------------------------------------------
    \begin{frame}\vspace*{-0em}
        \wwwfigH{evap-11}{jpg}{url}
    \end{frame}
    %-------------------------------------------------------------------------------------------
    \begin{frame}\vspace*{-0em}
        \wwwfigH{evap-12}{jpg}{url}
    \end{frame}
    %-------------------------------------------------------------------------------------------
