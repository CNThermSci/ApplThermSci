...
\subsection{Qualitativo}
    ...
    \begin{frame}{Trabalho de Fronteira -- Definição}\vspace*{-2em}
        ...
        \begin{itemize}
            ...
            \item de um \alert{sistema compressível simples}                \\[\medskipamount]
...
\subsection{Quantitativo}
    ...
    \begin{frame}{Trabalho de Fronteira -- Diferencial}\vspace*{-2em}
        ...
        \column{0.55\textwidth}
            ...
            \uncover<3->{\alt<3>%
                {$$\delta{W_f} = PdV$$}%
                {$$\delta{W_f} = PdV \rightharpoondown (/m)$$}%
            }
            \uncover<4->{$$\delta{w_f} = Pdv$$}
    ...
    \begin{frame}{Trabalho de Fronteira -- Processo}\vspace*{-2em}
        ...
        \column{0.55\textwidth}
            ...
            \uncover<2->{For a \alert{quasi-equilibrium} process $1$-$2$:}
            \uncover<3->{$$w_{12} = \int_1^2\delta{w_f} = \int_1^2P\,dv$$}
        \column{0.45\textwidth}
            \begin{figure}
