    ...
    \begin{frame}{Medição de $\mathsf{T}$ e $\mathsf{T}_{bu}$}\vspace*{-0em}
        \begin{itemize}
            ...
            \item<2-> Possível tanto pelas equações já apresentadas, sob a \alert{aproximação
                ...
                \\[\medskipamount]
            \item<3-> Ou por meio de uma \alert{carta psicrométrica} (a seguir), também sob a
                \alert{mesma hipótese $\mathsf{T}_{bu} \approx \mathsf{T}_{sa}$}.
                \\[\medskipamount]
            \item<4-> O uso do psicrômetro giratório é normalizado pela \texttt{ASTM E337}
                (vídeo no AVA).
        \end{itemize}
    \end{frame}
    %-------------------------------------------------------------------------------------------
