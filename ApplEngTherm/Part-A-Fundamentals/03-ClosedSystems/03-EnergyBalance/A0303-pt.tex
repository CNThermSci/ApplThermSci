...
%-----------------------------------------------------------------------------------------------
    ...
    \begin{frame}{Title}\vspace*{-2em}
        \uncover<1->{A \alert{primeira lei da termodinâmica} estabelece que:}
        \begin{itemize}
            \item<1-> \alert{Energia} é uma quantidade \alert{conservada}.
        \end{itemize}
        \uncover<2->{Logo, no universo observável:}
        \begin{itemize}
            \item<2-> \alert{Não há processos físicos} que \alert{criem} energia.
        \end{itemize}
    \end{frame}
    %-------------------------------------------------------------------------------------------
