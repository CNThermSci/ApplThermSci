...
%-----------------------------------------------------------------------------------------------
    ...
    \begin{frame}{Processos Politrópicos -- Definição}\vspace*{-2em}
        ...
        \begin{itemize}
            \item<2-> $P$ é a pressão do sistema
            \item<3-> $v$ é o volume específico do sistema
    ...
    \begin{frame}{Processos Politrópicos -- Apresentação}\vspace*{-2em}
        \begin{itemize}
            \item<1-> Contrário a processos de \alert{propriedade} const.
            \item<2-> Um \alert{parâmetro de processo}, $n$ é mantido const.
