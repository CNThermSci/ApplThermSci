...
%-----------------------------------------------------------------------------------------------
    ...
    \begin{frame}{Massa Molecular e Constante de Gás Aparentes:}\vspace*{-2em}
        ...
        \end{equation*}
        \begin{itemize}
            \item<3-> Modelo de calor específico para cada componente \alert{$k$}:
        \end{itemize}
        \vspace*{0.8em}\begin{equation*}
            \uncover<4->{
                \alert{\bar{c}_{p,k}(T) \eqmod \sum_{i=-4}^4 a_{i,k}T^i}\uncover<5>{\pm w_{cp}}\alert{,}
                    \qquad\alert{T_{min} \leqslant T \leqslant T_{max}}.
            }
        \end{equation*}
    \end{frame}
    %-------------------------------------------------------------------------------------------
