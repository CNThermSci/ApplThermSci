...
%-----------------------------------------------------------------------------------------------
    ...
    \begin{frame}{Energy Conservation --- Speed, No Heating, No Load}\vspace*{-2em}
        ...
        \column{0.67\textwidth}
            \uncover<1->{
                Input parameters---\FIR{fire} are corrections (\FIR{\textbf{bold}} parts):\\[\medskipamount]
                \begin{itemize}
                    ...
                    \item   \alert{$V_{min}=\unit{550.00}{\centi\meter\cubed}$},
                            ...
                            \FIR{$m_r=\unit{0.28\mathbf{3}}{\kilogram}$};
                    \item   \alert{$I_r=\unit{6.63\times 10^{-4}}{\kilogram\usk\squaren\meter}$},
                            \FIR{$I_c+I_f=\unit{5.5\mathbf{\times 10^{-3}}}{\kilogram\usk\squaren\meter}$};
                    \item   \FIR{$\mathbf{L_g=}\unit{\mathbf{28.6}}{\pmb{\milli\meter}}$},
                            ($r_g\approx 0.2368$),
                            \FIR{$\mathbf{\theta=}\unit{\mathbf{0}}{\pmb\degree}$},
                            \FIR{$\pmb\Delta\mathbf{t_c=}\unit{\mathbf{1}}{\pmb{\milli\second}}$};
            ...
            \uncover<1->{
                ...
                \begin{itemize}
                    \item   \alert{$R=\unit{44.95}{\milli\meter}$},
                            \FIR{$L=\unit{157.32\mathbf{5}}{\milli\meter}$},
                    ...
                    \item   \FIR{$\mathbf{L_g=}\unit{\mathbf{28.6}}{\pmb{\milli\meter}}$},
                            ($r_g\approx 0.1818$),
                            \FIR{$\mathbf{\theta=}\unit{\mathbf{-15}}{\pmb\degree}$},
                            \FIR{$\pmb\Delta\mathbf{t_c=}\unit{\mathbf{4}}{\pmb{\milli\second}}$};
                    \item   Air with \alert{$P_0=\unit{101.375}{\kilo\pascal}$},
                            \alert{$T_0=\unit{300}{\kelvin}$};
