...
%-----------------------------------------------------------------------------------------------
    ...
    \begin{frame}{Ciclo Otto padrão a ar de tempo finito de adição de calor---FTHA}\vspace*{-2em}
        \begin{itemize}
            \item<1->  Mantém-se como modelo de \alert{substância pura}:
            \begin{itemize}
                \item<2->  Evita \alert{combustão e equilíbrio químico};
                \item<3->  Evita modelagem termodinâmica de \alert{misturas reativas};
            \end{itemize}
            ...
            \begin{itemize}
                ...
                \item<9->  Ângulo de \alert{ignição};
            \end{itemize}
        \end{itemize}
    \end{frame}
    %-------------------------------------------------------------------------------------------
