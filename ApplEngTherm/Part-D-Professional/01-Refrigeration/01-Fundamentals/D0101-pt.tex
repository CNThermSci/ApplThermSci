...
%-----------------------------------------------------------------------------------------------
    ...
    % !j 96 -i8
    %-------------------------------------------------------------------------------------------
    \begin{frame}[allowframebreaks]{Introdução à Refrigeração -- }\vspace*{-2em}
        ...
        \begin{itemize}
            \item<1-> \alert{Refrigeração} é a ação de \alert{remoção de calor} de um
                ...
                temperatura};
                \\[\medskipamount]
            \item<1-> \alert{Sistemas de refrigeração} fazem isso criando uma \alert{superfície
                fria} para troca de calor com o sistema a ser resfriado;
                \\[\medskipamount]
            \item<1-> Devido à \alert{segunda lei da termodinâmica}, a superfície fria deve ser
