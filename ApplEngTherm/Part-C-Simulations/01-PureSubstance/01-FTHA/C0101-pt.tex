...
%-----------------------------------------------------------------------------------------------
    ...
    \begin{frame}{}\vspace*{-2em}
        \begin{center}
            \noindent\hspace*{-3.0mm}\includegraphics[height=70.0mm]{fig/test_r=12,0_speed-P.pdf}
        \end{center}
    \end{frame}
    %-------------------------------------------------------------------------------------------
    ...
    \begin{frame}{}\vspace*{-2em}
        \begin{center}
            \noindent\hspace*{-3.0mm}\includegraphics[height=70.0mm]{fig/test_r=12,0_speed-a.pdf}
        \end{center}
    \end{frame}
    %-------------------------------------------------------------------------------------------
    ...
    \begin{frame}{}\vspace*{-2em}
        \begin{center}
            \noindent\hspace*{-3.0mm}\includegraphics[height=70.0mm]{fig/test_r=12,0_speed-T.pdf}
        \end{center}
    \end{frame}
    %-------------------------------------------------------------------------------------------
