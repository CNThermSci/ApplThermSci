...
%-----------------------------------------------------------------------------------------------
    ...
    \begin{frame}{Temperatura do Ponto de Orvalho, $T_{\mathrm{po}}$}\vspace*{-2em}
        \begin{definition}
            \alert{Temperatura de ponto de orvalho} é definida como a temperatura na qual se dá
            o \alert{início da condensação} quando o ar é resfriado à \alert{pressão constante}.
        \end{definition}
    \end{frame}
    %-------------------------------------------------------------------------------------------
    ...
    \begin{frame}\vspace*{-2em}
        \begin{center}
            \begin{figure}
                ...
                \includegraphics[height=0.9\textheight]{fig/T-po-in-Ts-diag.pdf}
                \\\vspace*{-0.0em}\texttt{%
