...
%    %-------------------------------------------------------------------------------------------
    ...
    \begin{frame}{Balanço de Energia -- Em Processo (cont.)}\vspace*{-2em}
        \uncover<1->{$\Delta e_c$, $\Delta e_p$ não-negligíveis em sistemas fechados são de
        ...
        \begin{itemize}
            ...
            \item<3-> \alert{$\Delta e_p = \unit{1}{\kilo\joule\per\kilogram}$} implica em:
                ...
                \\[\medskipamount]
        \end{itemize}
        \uncover<4->{Assim, nos muitos outros casos, é possível negligenciá-las, simplificando o
        balanço:}
        \begin{align*}
            \uncover<5->{
...
%-----------------------------------------------------------------------------------------------
    ...
    \ArtEndW{nature-3086884_1280}{jpg}{txt}
