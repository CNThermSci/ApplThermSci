        ...
        \column{0.75\textwidth}
            ...
            \uncover<1->{
                \begin{itemize}
                    ...
                    \item \alert{symmetric} piston and rod (centers of mass);
                    \item \alert{balanced} crank and flywheel.
                    \item Parameters: \alert{$m_p$}, \alert{$m_r$}, \alert{$I_r$},
                        \alert{$I_c$}, and \alert{$I_f$}.
                \end{itemize}
            }
        \column{0.25\textwidth}
