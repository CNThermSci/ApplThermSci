...
%            \item<2-> $W_{acum}$ mostrado sob os processos
%            \item<3-> Exp.~$1$--$2$ \alert{produz} trabalho $W_{12} > 0$
%            \item<4-> Retorno ao estado $1$ requer \alert{consumo} de trabalho
%            \item<5-> Compr.~$2$--$1$ \alert{produz} trabalho $W_{21} < 0$
%            \item<6-> $W_{\mathrm{ciclo}} = (W_{12} + W_{21}) > 0$ é igual à \alert{área do
%                ciclo} em \alert{coordenadas $P-V$}.
%        \end{itemize}
%        \column{0.45\textwidth}
%            \begin{figure}
%                \only<1>{\includegraphics[width=5.0cm]{fig/A0301-pt-HPistCylPlotPath.pdf}}
%                \only<2>{\includegraphics[width=5.0cm]{fig/A0301-pt-HPistCylPlotCycle-00.pdf}}
%                \only<3>{\includegraphics[width=5.0cm]{fig/A0301-pt-HPistCylPlotCycle-01.pdf}}
%                \only<4>{\includegraphics[width=5.0cm]{fig/A0301-pt-HPistCylPlotCycle-02.pdf}}
%                \only<5>{\includegraphics[width=5.0cm]{fig/A0301-pt-HPistCylPlotCycle-03.pdf}}
