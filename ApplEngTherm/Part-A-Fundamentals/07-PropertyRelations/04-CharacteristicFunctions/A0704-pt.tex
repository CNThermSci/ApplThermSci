...
%-----------------------------------------------------------------------------------------------
    ...
    \begin{frame}{Funções Características vs. Equações de Estado (EoS)}
        It is worth noting that \EQ{eq:Ps.a} is an Equation of State, since it relates $P$, $v$, and $T$. Since it comes from a partial derivative of $a(T, v)$, one
        concludes that the characteristic function $a:a(T, v)$ contains more information than the equivalent Equation of State.

        Note further that the entropy comes from the partial derivative of $a(T,  v)$  with  respect  to  $T$,  meaning  that  the  both  EoS  information  and  the
        caloric/entropic data are embed in the characteristic function $a:a(T, v)$.
