...
%-----------------------------------------------------------------------------------------------
    ...
    \begin{frame}\vspace*{-2em}
        \begin{columns}
            ...
            \begin{center}                                               
                \begin{figure}                                           
                    \fontsize{5.0}{5}\selectfont                         
                    \includegraphics[height=0.68\textheight]{www/01-cold-dr-pepper.jpg}   
    ...
    \begin{frame}\vspace*{-2em}
        \begin{columns}
            \column{0.50\textwidth}
            \wwwfigWID{03-LN2}{jpg}{short}{0.96\textwidth}
            \column{0.50\textwidth}
            \wwwfigWID{04-windshield-ice}{jpg}{short}{0.96\textwidth}
        \end{columns}
    \end{frame}
    %-------------------------------------------------------------------------------------------
    ...
    \begin{frame}\vspace*{-2em}
        \begin{columns}
            \column{0.50\textwidth}
            \wwwfigWID{05-clouds-rain}{jpg}{short}{0.96\textwidth}
            \column{0.50\textwidth}
            \wwwfigWID{07-Sachseln-snow}{jpg}{short}{0.96\textwidth}
        \end{columns}
    \end{frame}
    %-------------------------------------------------------------------------------------------
