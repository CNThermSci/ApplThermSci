...
%    %-------------------------------------------------------------------------------------------
    ...
    \begin{frame}{Balanço de Energia -- $E_{sist}$}\vspace*{-2em}
        \uncover<1->{Em \alert{sistemas clássicos\footnote{Clássicos: pré-relativísticos} não
        reativos}, $E_{sist}$ inclui as formas:}\\[\medskipamount]
        \begin{enumerate}
            \item<2-> Microscópicas, agrupadas na \alert{energia interna}, $U_{sist}$,
                \uncover<3->{além das formas macroscópicas:}\\[\medskipamount]
