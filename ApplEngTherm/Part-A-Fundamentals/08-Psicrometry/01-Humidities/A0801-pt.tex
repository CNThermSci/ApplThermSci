...
%-----------------------------------------------------------------------------------------------
    ...
    %-------------------------------------------------------------------------------------------
    \begin{frame}{Ar Seco e Ar Atmosférico --- Aproximações}\vspace*{-2em}
        ...
        \end{align*}
        Ainda, considerando \alert{comportamento $P-V-T$ ideal} da mistura, tem-se a
        \alert{pressão de vapor}, $P_v$, como a pressão parcial (ou componente) do vapor:
        \begin{equation*}
            \alert{
                P = P_a + P_v
            }.
