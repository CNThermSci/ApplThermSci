...
%-----------------------------------------------------------------------------------------------
    ...
    \begin{frame}{Energia Interna -- Relação com Temperatura}\vspace*{-2em}
        ...
        \column{0.55\textwidth}
            O sistema fechado de massa $m$, ilustrado:
            \begin{itemize}
                \item Recebe uma diferencial de calor a volume constante: $(\delta q)_V$
                \item $m$ e $V$ constantes implicam em $v \equiv V/m$ constante
                \item Tal que $(\delta q)_V = (\delta q)_v$
            \end{itemize}
