...
%-----------------------------------------------------------------------------------------------
    ...
    \begin{frame}{Ciclo Otto padrão a ar de tempo finito de adição de calor---FTHA}\vspace*{-2em}
        \begin{itemize}
            ...
            \begin{itemize}
                \item<6->  Evita \alert{equilíbrio e reações químicas} e \alert{misturas};
            \end{itemize}
            \item<7->  Inclui parâmetros \alert{construtivos} do \alert{motor};
            \item<8->  Inclui parâmetros \alert{operacionais} do \alert{motor}.
        \end{itemize}
    \end{frame}
    %-------------------------------------------------------------------------------------------
