...
%-----------------------------------------------------------------------------------------------
    ...
    %-------------------------------------------------------------------------------------------
    \begin{frame}{Visão Geral dos Ciclos Motores}
        \only<1>{\figfig{fig/basic_engine.svg}}
        \only<2>{\figfig{fig/basic_engine_simp_1.svg}}
        \only<3>{\figfig{fig/basic_engine_simp_2.svg}}
        \only<4>{\figfig{fig/basic_engine_simp_3.svg}}
    \end{frame}
    %-------------------------------------------------------------------------------------------
