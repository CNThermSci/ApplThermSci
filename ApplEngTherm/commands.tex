...
\newcommand{\wwwfig}[3]{%
    \begin{center}
        \begin{figure}
            ...
            \includegraphics[width=\textwidth]{www/#1.#2}
            \\\vspace*{-1em}\verbatiminput{www/#1.#3}
        \end{figure}
    \end{center}
}
\newcommand{\wwwfigH}[3]{%
    \begin{center}
        \begin{figure}
            \fontsize{5.0}{5}\selectfont
            \includegraphics[height=0.8\textheight]{www/#1.#2}
            \\\vspace*{-1em}\verbatiminput{www/#1.#3}
        \end{figure}
    \end{center}
}
\newcommand{\wwwfigWID}[4]{%
    \begin{center}
        \begin{figure}
            \fontsize{5.0}{5}\selectfont
            \includegraphics[width=#4]{www/#1.#2}
            \\\vspace*{-1em}\verbatiminput{www/#1.#3}
        \end{figure}
    \end{center}
}
\newcommand{\wwwfigHEI}[4]{%
    \begin{center}
        \begin{figure}
            \fontsize{5.0}{5}\selectfont
            \includegraphics[height=#4]{www/#1.#2}
            \\\vspace*{-1em}\verbatiminput{www/#1.#3}
        \end{figure}
    \end{center}
}
