...
%-----------------------------------------------------------------------------------------------
    ...
    \begin{frame}{Processos Politrópicos -- Trabalho de Fronteira -- Gases Ideais}\vspace*{-2em}
        ...
        \uncover<1->{
            ...
            politrópico, \alert{$Pv^n = \mbox{const.}$}, o resultado \\[\medskipamount]
        }
        \begin{equation*}
            \uncover<2->{
            w_f = \left.\begin{cases}
        ...
        \column{0.50\textwidth}
        \uncover<3->{
            \noindent também pode ser escrito como: \\[\medskipamount]
        }
        \begin{equation*}
            \uncover<4->{\alert{
            w_f = \left.\begin{cases}
...
%-----------------------------------------------------------------------------------------------
    ...
    \ArtEndW{fishermen-504098_1280}{jpg}{txt}
