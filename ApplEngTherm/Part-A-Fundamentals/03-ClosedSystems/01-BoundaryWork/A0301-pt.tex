...
\subsection{Qualitativo}
    ...
    \begin{frame}<handout:0>{Trabalho de Fronteira -- Aplicações}\vspace*{-2em}
        ...
        \begin{itemize}
            ...
            \item Motores \textbf{\alt<1>{\alert{Stirling}}{Stirling}}
            \item Compressores alternativos
            \item Motores \textbf{\alt<2>{\alert{lineares}}{lineares}}
            \item Elevadores de carga e atuadores
            \item Expansores \textbf{\alt<3>{\alert{criogênicos}}{criogênicos}}
        \end{itemize}
