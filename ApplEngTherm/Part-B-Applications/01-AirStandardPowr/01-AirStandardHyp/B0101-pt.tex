...
%-----------------------------------------------------------------------------------------------
    ...
    \begin{frame}{}\vspace*{-2em}
        Máquinas que desempenham ciclo motores são complexas:
        \begin{columns}
        \column{0.5\textwidth}
            \begin{center}
                \begin{figure}
                    \fontsize{3.0}{4}\selectfont
                    \includegraphics[width=0.975\textwidth]{www/1024px-J85_ge_17a_turbojet_engine.jpg}
                    \\\vspace*{-2em}\verbatiminput{www/1024px-J85_ge_17a_turbojet_engine.url}
                \end{figure}
            \end{center}
        \column{0.5\textwidth}
            \begin{figure}
                \includegraphics[width=0.95\textwidth]{www/GE_H_series_Gas_Turbine.jpg}
            \end{figure}
        \end{columns}
    \end{frame}
    %-------------------------------------------------------------------------------------------
