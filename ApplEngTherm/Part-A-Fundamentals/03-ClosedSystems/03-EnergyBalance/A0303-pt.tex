...
%    %-------------------------------------------------------------------------------------------
    ...
    \begin{frame}{Balanço de Energia -- $E_{sist}$}\vspace*{-2em}
        ...
        \begin{enumerate}
            ...
            \item<5-> $E_c = m\smcpbb{V}^2/2000$, com $\llbracket\smcpbb{V}\rrbracket =
                \meter\per\second = \sqrt{\joule\per\kilogram}$; \\[\medskipamount]
            \item<6-> $E_p = mg\mathbb{Z}$, com $\llbracket g\rrbracket =
                \meter\per\squaren\second$ e $\llbracket\mathbb{Z}\rrbracket = \kilo\meter$, tal
                que $\llbracket g\mathbb{Z}\rrbracket = \kilo(\meter\per\second)^2 =
                \kilo(\joule\per\kilogram)$, ou \\[\medskipamount]
            \item<7-> $E_p = mg\smcpbb{Z}/1000$, com $\llbracket g\rrbracket =
    ...
    \begin{frame}{Balanço de Energia -- Em Processo}\vspace*{-2em}
        \begin{align*}
            ...
            \uncover<5->{
                ...
                \alert{= \Delta{U} + \Delta{E_c} + \Delta{E_p}}.
                \quad\qquad\qquad\text{(conv.~explícita)}
            } \\[\medskipamount]
            \uncover<6->{
                \alert{Q - W} &
                \alert{= \Delta{U} + \Delta{E_c} + \Delta{E_p}}.
                \quad\qquad\qquad\text{(conv.~implícita)}
            } %\\[\medskipamount]
        \end{align*}
    \end{frame}
    %-------------------------------------------------------------------------------------------
