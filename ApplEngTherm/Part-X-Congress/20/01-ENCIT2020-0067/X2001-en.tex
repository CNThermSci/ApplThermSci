    ...
    \begin{frame}{Dynamic Modeling --- Kinetics}\vspace*{-2em}
        ...
        \column{0.75\textwidth}
            ...
            \uncover<1->{
                ...
                \alert{$\beta_y \equiv r/\ell = \tan\phi/\tan\alpha$}, then:
                \begin{align*}
                    \ddot{\mathsf{y}}_p &= \bsans{y}_{p}\mathbf{\Omega},\qquad\mbox{with}\qquad
                        \bsans{y}_{p}   \equiv \begin{bmatrix}
                            \mathsf{y}_{p\omega} &
                            \mathsf{y}_{p\dot\omega}
                        \end{bmatrix}   =  -\begin{bmatrix}
                            r(1+\beta_y) + h\mathsf{a}_{\omega} &
                            h(1+\beta_y)
                        \end{bmatrix}, \\
                    \ddot{\mathsf{x}}_r &= \bsans{x}_{r}\mathbf{\Omega},\qquad\mbox{with}\qquad
                        \bsans{x}_{r}   \equiv \begin{bmatrix}
                            \mathsf{x}_{r\omega} &
                            \mathsf{x}_{r\dot\omega}
                        \end{bmatrix}   =  +\begin{bmatrix}
                            -h(1-r_g) &
                            r(1-r_g)
                        \end{bmatrix},\qquad\qquad\qquad r_g \equiv L_g/L, \\
                    \ddot{\mathsf{y}}_r &= \bsans{y}_{r}\mathbf{\Omega},\qquad\mbox{with}\qquad
                        \bsans{y}_{r}   \equiv \begin{bmatrix}
                            \mathsf{y}_{r\omega} &
                            \mathsf{y}_{r\dot\omega}
                        \end{bmatrix}   =  -\begin{bmatrix}
